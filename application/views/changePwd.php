...
<form action="<?php echo base_url() . 'index.php/login/change_password'; ?>" method="POST" id="changePwd">
    <fieldset>
        <!-- Current -->
        <?php
        ...
        {
            echo "<h5 class='error'>".$changePasswordError."</h5><br />";
        }
         $this->session->set_userdata('changePasswordError', '');       
        ?>
        <div>
