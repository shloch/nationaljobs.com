    ...
    <body>
        ...
        <div id="globalDiv">
            ...
            <div id="middle"><!--begin of MIDDLE div--->
                ...
                <div id="content" style="padding: 10% 0%; text-align: center;">
                    <?php
                    $file = $this->session->userdata('member_id') . '.pdf';

                    echo '<a href="' . base_url() . 'medias/pdf_cvs/cv_' . $file . '" class="googleButton" title="Download/display PDF CV">Click Here to obtain CV in PDF</a>';
                    ?>
                </div>
